$(document).ready(function(){
    $('#send_message1').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e12').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSeS9bgKCsfZNdmC-VI9lYkQJcqJ3U7catAn_2yMZuqi-sX9mg/formResponse");
                                ...
                                if (region != null)
                                    {
                                        ...
                                        else
                                        {
                                            $('#send_message1').css({transition:"1s"});
                                            $('#send_message1').prop("disabled", true);
                                            $('#send_message1').prop("value", "필요 DB 규모를 확인하세요.");
                                            $('#send_message1').css({background:"#595959"});
                                            $('#send_message1').css({cursor:"default"});        
                                        }
...
$(function(){
 $('#name1,#phone1,#region,#db4,#memo,#agree').bind("keyup click change",form_check2);
